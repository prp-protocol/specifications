...
PRP binds the selected profile and cryptographic suite into the Noise
transcript with this compact binary context:

| Offset | Size | Type | Meaning |
| ---: | ---: | --- | --- |
| 0 | 1 | `uint8` | selector: profile code in bits `7..6`, suite id in bits `5..0` |

This one-byte context is not a negotiation transcript by itself. It is a
...
3. mix the one-byte PRP transcript context into `h` as prologue;
